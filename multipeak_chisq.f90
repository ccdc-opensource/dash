...
!
     ...
     &                VALMUB
!
      COMMON /WWF4PARS/ NGEN4(9,5), F4VAL(3,MF4PAR), F4PAR(3,MF4PAR),   &
     &                  KF4PAR(3,MF4PAR), F4PESD(3,MF4PAR), KOM6
!
      COMMON /WWIOUNIT/ LPT, ITI, ITO, IPLO, LUNI, IOUT
      COMMON /WWNEWOLD/ SHIFT, XOLD, XNEW, ESD, IFAM, IGEN, ISPC, NEWIN,&
...
!
     ...
     &                  JOCCR(MPTS)                          !,
!
      COMMON /WWCMN300/ ZNORMT(MAXPIK), DZNDKQT(MAXPIK),                &
     &                  DZNDVQT(9,MAXPIK), KARGO(MAXPIK), KARGK(MAXPIK)
!
      PARAMETER (MPAR=50)
      REAL P(MPAR)
      PARAMETER (MPT=2000)
