...
! CSSR ...
 ...
 1010   FORMAT ('   ALPHA,BETA,GAMMA =',3F8.3,'    SPGR = ',A3)
        IF (PrefParExists) THEN
          WRITE (hFileCSSR,"(' ',I3,'   0 PO',4(1X,F6.3))",ERR=999) natom,(PrefPars(ii),ii=1,3),SNGL(XOPT(iPrfPar))
        ELSE
...
! Add in a Header record
        ...
        IF (PrefParExists) THEN
          WRITE (hFilePDB,'(A,4(1X,F6.3))',ERR=999) 'REMARK PO',(PrefPars(ii),ii=1,3),SNGL(XOPT(iPrfPar))
        ENDIF
...
! CCL ...
      IF (tSaveCCL) THEN
        ...
        IF (PrefParExists) THEN
          WRITE (hFileCCL,'(A,4(1X,F6.3))',ERR=999) 'Z PO',(PrefPars(ii),ii=1,3),SNGL(XOPT(iPrfPar))
        ENDIF
...
!     6 = Fe
        ...
        IF (PrefParExists) THEN
          ...
          WRITE (hFileCIF,'("  Magnitude   = ",F6.3)',ERR=999) SNGL(XOPT(iPrfPar))
          WRITE (hFileCIF,'(";")',ERR=999)
        ENDIF
!C data_FILENAME
...
! RES ...
      IF (tSaveRES) THEN
        ...
        IF (PrefParExists) THEN
          WRITE (hFileRES,'(A,4(1X,F6.3))',ERR=999) 'REM  PO',(PrefPars(ii),ii=1,3),SNGL(XOPT(iPrfPar))
        ENDIF
