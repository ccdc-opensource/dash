...
! Use standard PDB orthogonalisation
      ...
      LOGICAL tSavePDB, tSaveCSSR, tSaveCCL, tSaveCIF
      INTEGER ipcount
...
! CSSR ...
 ...
 1010   FORMAT ('   ALPHA,BETA,GAMMA =',3F8.3,'    SPGR = ',A3)
        ...
        WRITE (hFileCSSR,1030) TemperatureStr, -SNGL(fopt), cpb, ntotmov
...
! PDB ...
      IF (tSavePDB) THEN
        ...
        hFilePDB = 65
        OPEN (UNIT=hFilePDB,FILE=tFileName(1:OFBN_Len+8),STATUS='unknown')
        CALL sagminv(f2cpdb,inv,3)
! Add in a Header record
        WRITE (hFilePDB,"('HEADER    PDB Solution File generated by DASH')")
        WRITE (hFilePDB,1040) TemperatureStr, -SNGL(fopt), cpb, ntotmov
...
! CCL ...
      IF (tSaveCCL) THEN
        ...
        WRITE (hFileCCL,1090) TemperatureStr, -SNGL(fopt), cpb, ntotmov
...
!
      ...
      REAL, INTENT (IN   ) :: ProfileChi, IntensityChi
      ...
      CALL Log_SARun_Entry(OutputFilesBaseName(1:OFBN_Len)//'_'//SA_RunNumberStr//'.pdb',ProfileChi,IntensityChi)
