...
def write_email(org, out, do_send = 1):
    ...
    body_text +="Here are your DASH license key(s) for 2012:\n\n"
    for licence in org.licence_data:
        if licence.key != None:
    ...
    body_text += "\nThis licence key expires on 30 September 2012. Before the licence expires we will send a replacement\n"
    body_text += "\n\nBest Wishes\n\nLauren Thomas\nCCDC"
